// This graph class was taken from Peer Code 7550 :
// https://github.com/cme212/peercode/blob/master/hw2/Graph-7550.hpp.
// Since I could not get my remove edge or remove node to work, this 
// was the only way to fix this issue. 
