...
class Graph {
  ...
  class Node : private totally_ordered<Node> {
    ...
    */
    const node_value_type& value() const {
      return const_cast<node_value_type& >(graph_->nodes_[uid_].value);
    }
  ...
  class Edge : private totally_ordered<Edge>{
    ...
    */
    ...
    const edge_value_type& value() const {
      ...
      return const_cast<edge_value_type&>(graph_->edges_[0][0].value);
    }
  ...
  * May invalidate outstanding Edge indices (new edge(i) != old edge(i)) and Edge/Incident Iterators
  *
  * @param[in] EdgeIterator @e_it, pointing to the Edge to remove
  * @return an EdgeIterator pointing to the next Edge in the graph (or edge_end())
  *
  * Let e = (*e_it)
  * @pre has_node(e.node1()) && has_node(e.node2())
  * @pre has_edge(e.node1(), e.node2())
  ...
  */
  ...
  /** @brief Remove the Edge at position i_it from the graph
  *
  * Does not invalidate outstanding Edge objects, except for those equal to the Edge being deleted.
  * May invalidate outstanding Edge indices (new edge(i) != old edge(i)) and Edge/Incident Iterators
  *
  * @param[in] IncidentIterator i_it, pointing to the edge to remove
  * @returns an IncidentIterator pointing to the next edge in node 1's adjacency list, or node1().edge_end()
  *
  * Let e = (*i_it)
  * @pre has_node(e.node1()) && has_node(e.node2())
  * @pre has_edge(e.node1(), e.node2())
  ...
  */
  ...
  incident_iterator remove_edge(incident_iterator i_it){
    auto node1_uid = i_it.node1_uid_;
    auto node2_index = i_it.node2_index_;
    //remove the Edge
    remove_edge(*i_it);

    return IncidentIterator(this, node1_uid, node2_index);
  }
