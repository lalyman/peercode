  ...
  class EdgeIterator {
   public:
    ...
    EdgeIterator& operator++() {
      ...
      //std::cout << "i2u_.size(): " << graph_->i2u_.size() << ", adj_list.size(): "<< adj_list.size() << std::endl;
      //std::cout << "n1_idx_: " << n1_idx_ << ", adj_list_pos_: "<< adj_list_pos_ << std::endl;
      ...
      //std::cout << n1_idx_ << " >? "<<  n2_idx  << std::endl;
