...
class Graph {
 ...
 public:
  ...
  //Type of the value assosciated with the nodes.
  ...
  class EdgeIterator{
    public:
        ...
        EdgeIterator& operator ++(){
            if(nid2_==graph_->node(nid1_).degree()-1){
                nid1_++;
                nid2_=0;
                return *this;
            }
 ...
 private:
  ...
  //, value and adjaceny list for each node. The Node class is effectively a 
  //pointer to an object of NodeInfo.
    class NodeInfo{
        private:
            ...
            NodeInfo(Point point, node_value_type value){
                this->point_=point;
                this->value_=value;
            }
    };
