 ...
 public:
  ...
  class Node : private totally_ordered<Node>{
   public:
    ...
    void setValue(node_value_type n){
      graphPtr->nodes[idx].value = n;
    }
    ...
    incident_iterator edge_begin() const{
      return IncidentIterator(graphPtr,(graphPtr->connections.at(idx).begin()));
    };
    incident_iterator edge_end() const{
      return IncidentIterator(graphPtr,(graphPtr->connections.at(idx).end()));
    };
  ...
  Node node(size_type i) const {
    return Node(this,nodes[i].idx);        // Invalid node
  }
