 ...
 public:
  ...
  class Node {
   public:
    ...
    Node(Point someposition, size_type someindex) {
      pos = someposition; 
      nodeindex = someindex; 
    }
  ...
  Node add_node(const Point& position) {
    // HW0: YOUR CODE HERE
    nodes.push_back(Node(position, this->size()));     
    return nodes.back();       
  }
  ...
  class Edge {
   public:
    ...
    Edge(Node a, Node b, size_type l) {
      nodea = a;
      nodeb = b;
      edgeindex = l;
    }
    ...
    Node node1() const {
      // HW0: YOUR CODE HERE
      return nodea;      // Invalid Node
    }

    /** Return the other node of this Edge */
    Node node2() const {
      // HW0: YOUR CODE HERE
      return nodeb;      // Invalid Node
    }
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    edges.push_back(Edge(a, b, num_edges()));
    return edges.back();  
  }
