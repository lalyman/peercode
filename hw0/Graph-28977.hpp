...
class Graph {
 ...
 public:
  ...
  Graph() {
    // HW0: YOUR CODE HERE
    // blank because node_list and edge_list are empty by default
  }
  ...
  bool has_node(const Node& n) const {
    // HW0: YOUR CODE HERE
    return node_list[n.ind_] == n.position();
  }
  ...
  class Edge {
   ...
   private:
    ...
    size_type a_;
    size_type b_;
    Edge(const Graph* g, size_type ind, size_type n1, size_type n2) 
      : g_(const_cast<Graph*>(g)), ind_(ind), a_(n1), b_(n2){
    }
  };
  ...
  bool has_edge(const Node& a, const Node& b) const {
    ...
    for (size_type i = 0; i < num_edges(); i++) {
      if (edge_list[i] == Edge(this, i, a.index(), b.index())) {
        found = true;
      }
    }
    return found;
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    Edge new_edge = Edge(this, i, a.index(), b.index());
 ...
 private:
  ...
  std::vector<Edge> edge_list;  // will probably need to be adj list in future
