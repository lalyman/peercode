...
class Graph {
 ...
 public:
  ...
  Node add_node(const Point& position) {
    ...
    this->point_map[this->number_of_nodes] = new Point(position.x, position.y, position.z);
    this->node_map[this->number_of_nodes] = new_node;
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    this->edge_indexation[this->number_of_edges] = new_edge;
   ...
   */
  void clear() {
    for (size_type i=0; i<this->number_of_edges; i++){
      delete this->edge_indexation[i];
    }
    for (size_type i=0; i<this->number_of_nodes; i++){
      delete this->node_map[i];
      delete this->point_map[i];
    }
