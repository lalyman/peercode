...
class Graph {
 ...
 public:
  ...
  class Edge {
   public:
    ...
    bool operator==(const Edge& e) const {
      if (this->graph_ == e.graph_ and this->id_ == e.id_) return true; 
      return false;
    }
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    for (size_type i=0; i<esize_; i++) {
        if ((n1==edge_n1s_[i] and n2==edge_n2s_[i]) or \
        (n1==edge_n2s_[i] and n2==edge_n1s_[i])) return Edge(this,i);
    }
    esize_++;
    edge_n1s_.push_back(a.id_);
    edge_n2s_.push_back(b.id_);
    return Edge(this,esize_-1);
  }
